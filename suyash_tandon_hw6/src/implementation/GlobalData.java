...
public class GlobalData extends ClockedPropertiesContainer implements IGlobals {
    ...
    public static int div_count=0;
    public static int fdiv_count=0;
     public static String[] i_queue=new String[256];
    public static int i_queue_index=0;    
    public static Latch[] i_latch=new Latch[256];
